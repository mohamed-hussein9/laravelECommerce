                                ...
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->utype==='USR')
                                            <li class="menu-item menu-item-has-children parent" >
                                                <a title="" href="#">Acount ({{ Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency" >
                                                    <li class="menu-item" >
                                        ...
                                        @else
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item" >
                                                        <a title="category" href="{{route('admin.caregories')}}">Categories</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="products" href="{{route('admin.products')}}">Products</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="manage home sliders" href="{{route('admin.homesliders')}}">Manage Sliders</a>
                                                    </li>
                                                    <li class="menu-item" >
                                                        <a title="manage home sliders" href="{{route('homeproducts')}}">Home Products</a>
                                                    </li>

                                                    <li class="menu-item" >
                                                        <a title="admin sale" href="{{route('admin.sale')}}">Manage sale</a>
                                                    </li>
